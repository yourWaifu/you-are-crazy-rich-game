...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"78a455b6-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/Game/App.vue?vue&type=template&id=422596ae&
var Appvue_type_template_id_422596ae_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('h4',[_vm._v(_vm._s(_vm.message))]),_c('p',[_vm._v("Money per second:"),_c('NumberDisplay',{attrs:{"value":_vm.moneyGenRatePreSec}}),_vm._v(_vm._s(_vm.currency))],1),_c('p',[_vm._v("Money count:"),_c('NumberDisplay',{attrs:{"value":_vm.moneyCountDisplay}}),_vm._v(_vm._s(_vm.currency))],1),(_vm.loaded)?_c('LineChart',{attrs:{"chart-data":_vm.moneyChartData,"options":_vm.moneyChartOptions},on:{"chart:update":function($event){return _vm.onChartUpdated();}}}):_vm._e(),_c('p',[_vm._v("Time Left:"),_c('NumberDisplay',{attrs:{"value":_vm.timeLeftDisplay}}),_vm._v("seconds")],1),_c('button',{on:{"click":function($event){return _vm.onDonate();}}},[_vm._v("Donate "+_vm._s(_vm.donationPower)+" "+_vm._s(_vm.currency))]),_c('br'),_c('p',[_vm._v("Upgrades")]),_vm._l((_vm.upgradesShop),function(upgrade,index){return _c('button',{key:upgrade.name,on:{"click":function($event){return _vm.buyUpgrade(index)}}},[_vm._v(" "+_vm._s(upgrade.name)+" +"+_vm._s(_vm.formatNumberToSI(upgrade.profit))+_vm._s(_vm.currency)+" ")])}),_c('p',[_vm._v("Actions")]),_vm._l((_vm.availableActions),function(action,index){return _c('span',{key:'action' + action.id,on:{"click":function($event){return _vm.doAction(index)}}},[_c('button',[_vm._v(_vm._s(action.name)+" +"+_vm._s(_vm.formatNumberToSI(action.profit, function (value) { return value.toFixed(2); }))+_vm._s(_vm.currency))]),_vm._v(_vm._s(action.count)+" ")])})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/Game/App.vue?vue&type=template&id=422596ae&
...
function (_Vue) {
  ...
  function App() {
    ...
    _this.clock = 0;
    _this.baseTimeLeft = 2629746;
    _this.timeLeft = _this.baseTimeLeft;
    _this.time = 0;
    ...
    }), new Appvue_type_script_lang_ts_UpgradeStats("Start selling warehouses", 1000000000, function (game) {
    ...
    }), new Appvue_type_script_lang_ts_UpgradeStats("Start lowering the price of AWS", 10000000000, function (game) {
      return game.moneyGenRatePreSec <= -21000;
    }, function (game) {
      game.availableActions.push(_this.actions[ActionID.CheaperAWS]);
    }), new Appvue_type_script_lang_ts_UpgradeStats("Start thowing away Amazon's server", 50000000000, function (game) {
      return game.moneyGenRatePreSec <= -26000;
    }, function (game) {
      game.availableActions.push(_this.actions[ActionID.SlowerAmazonWebsite]);
    }), new Appvue_type_script_lang_ts_UpgradeStats("Shutdown the Amazon company", 500000000000, function (game) {
        ...
        yAxes: [{
          ...
          ticks: {
            callback: function callback(value) {
              return _this.formatNumberToSI(value);
            }
          }
        }]
      },
  ...
  Object(createClass["a" /* default */])(App, [{
    key: "formatNumberToSI",
    value: function formatNumberToSI(num) {
      var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (num) {
        return String(num);
      };
      if (this.sIPrefixes[0].base10 <= num) //special case
        return callback(num);

      for (var i = 1; i < this.sIPrefixes.length; i++) {
    ...
    value: function onTick() {
      ...
      if (!this.hasFailed && !this.hasWon) this.timeLeft = this.baseTimeLeft - this.time;
      ...
      if (this.chartRendered && this.moneyChartData.datasets != undefined && this.moneyChartData.datasets[0].data != undefined) {
        var data = this.moneyChartData.datasets[0].data; //remove data that is too old

        data = data.filter(function (value, index) {
          return value.x !== undefined ? _this3.time - 60 * 2 < value.x ? _this3.time - 60 * 1.5 < value.x ? _this3.time - 60 < value.x ? true : Math.floor(value.x) % 3 : Math.floor(value.x) % 2 : false : false;
        }); //add new data
...
var App_component = Object(componentNormalizer["a" /* default */])(
  ...
  Appvue_type_template_id_422596ae_render,
  staticRenderFns,
  false,
  null,
  null,
...
/******/ });
//# sourceMappingURL=game.2f8e55fb.js.map